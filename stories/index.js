...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form student="Frodo Baggins" interviewer={2} interviewers={interviewers} onSave={action("onSave")} onCancel={action("onCancel")}/>)
  ...
  .add("Appointment Booked", () => (
    <Fragment>
      <Appointment
        id={1}
        time="4pm"
        interview={{ student: "Lydia Miller-Jones", interviewer: "test" }}
      />
